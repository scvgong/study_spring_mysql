...
<body>
    ...
    <!-- Main Content -->
    <form action="/commonCode/list" class="get">
        <div class="container mt-4">
                ...
                <div class="col-12">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td><input type="checkbox" class="form-check-input" name = "deleteIds" value='<%= record.get("PK_ID") %>'></td>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    <li class="page-item"><button class="page-link" type="submit" name="page" value="Previous">Previous</button></li>
                    <li class="page-item"><button class="page-link" type="submit" name="page" value="1">1</button></li>
                    <li class="page-item"><button class="page-link" type="submit" name="page" value="2">2</button></li>
                    <li class="page-item"><button class="page-link" type="submit" name="page" value="3">3</button></li>

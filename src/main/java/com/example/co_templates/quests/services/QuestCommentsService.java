...
public class QuestCommentsService {
    ...
    public void callCommentsList(HashMap<String,Object> dataMap){
        String sqlMapId = "Comments.selectBysearch";
        Object list = shareDao.getList(sqlMapId, dataMap);
    }

    public void callCommentsInsert(HashMap<String,Object> dataMap){
    ...
    public void callCommentsUpdate(HashMap<String,Object> dataMap){
    ...
    public void callCommentsDelete(HashMap<String,Object> dataMap){
